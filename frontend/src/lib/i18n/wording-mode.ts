...
export const WORDING: Record<WordingMode, WordingPack> = {
  lower: {
    ...
    release_actions: {
      empty: { label: '埋入泥土', hint: '放低安放 · 會長成一棵小樹苗' },
      share: { label: '摺成信放入信封', hint: '摺成一封信 · 交俾你想分享嘅人' },
      set_aside: { label: '放入書枱', hint: '打開櫃桶收埋 · 遲啲再諗' },
      send_away: { label: '摺成紙飛機', hint: '一次過輕輕送遠 · 飛到海島唔見' },
      wash: { label: '洗乾淨', hint: '入去沖涼房沖一沖 · 出返嚟乾淨曬' },
      let_flow: { label: '摺成紙船放入小河', hint: '交俾流水慢慢帶走 · 唔使大力掟' },
    ...
    release_diary_actions: {
      empty: { label: '埋入泥土', hint: '放低呢頁 · 會長成一棵小樹苗' },
      share: { label: '摺成信放入信封', hint: '摺成一封信 · 交俾你想分享嘅人' },
  ...
  upper: {
    ...
    release_actions: {
      empty: { label: '埋入泥土', hint: '放低安放 · 等佢長成一棵小樹苗' },
      share: { label: '摺成信放入信封', hint: '摺成一封信 · 交俾你想分享嘅人' },
      set_aside: { label: '放入書枱', hint: '打開櫃桶收埋 · 遲啲再諗' },
      send_away: { label: '摺成紙飛機', hint: '一次過輕輕送遠 · 向海島飛走' },
      wash: { label: '洗乾淨', hint: '入去沖涼房沖一沖 · 出返嚟乾淨曬' },
      let_flow: { label: '摺成紙船放入小河', hint: '交俾流水慢慢帶走 · 唔使大力掟' },
      keep_hug: { label: '放入盒鎖好', hint: '合上再鎖 · 只有你睇到' },
    },
    ...
    release_diary_actions: {
      empty: { label: '埋入泥土', hint: '放低呢頁 · 等佢長成樹苗' },
      share: { label: '摺成信放入信封', hint: '摺成一封信 · 交俾你想分享嘅人' },
      set_aside: { label: '放入書枱', hint: '放入櫃桶 · 遲啲再決定都得' },
      send_away: { label: '摺成紙飛機', hint: '一次過輕輕送遠 · 向海島飛走' },
      wash: { label: '抹乾淨', hint: '入去沖一沖 · 出返嚟清爽晒' },
