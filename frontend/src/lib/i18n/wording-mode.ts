...
export const WORDING: Record<WordingMode, WordingPack> = {
  lower: {
    ...
    release_actions: {
      ...
      let_flow: { label: '放入小河', hint: '輕輕放到水面 · 等佢自己漂走' },
    ...
    release_diary_actions: {
      ...
      let_flow: { label: '摺成紙船放入小河', hint: '摺成紙船 · 放入小河漂走' },
  ...
  upper: {
    ...
    release_actions: {
      ...
      send_away: { label: '摺成紙飛機', hint: '向住海島飛走 · 輕輕放手' },
      wash: { label: '洗乾淨', hint: '入去沖涼房沖一沖 · 出返嚟乾淨曬' },
      let_flow: { label: '放入小河漂走', hint: '讓呢碗沿住流水自己走' },
      keep_hug: { label: '放入盒鎖好', hint: '合上再鎖 · 只有你睇到' },
    },
    release_diary_title: '想點處置今日呢份日記?',
  ...
  adult: {
    ...
    release_actions: {
      ...
      let_flow: { label: '讓它順水流走', hint: '放到水面 · 讓流水帶走' },
    ...
    release_diary_actions: {
      ...
      send_away: { label: '摺成紙飛機', hint: '向海島飛走 · 象徵放手' },
      wash: { label: '抹乾淨', hint: '入去沖一沖 · 出返嚟清爽晒' },
      let_flow: { label: '摺成紙船順水流走', hint: '摺成紙船 · 讓流水帶走' },
