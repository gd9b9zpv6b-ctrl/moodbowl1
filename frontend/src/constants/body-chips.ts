 ...
 * `region` must match anatomy (mouth/face → head, shoulders → chest, etc.).
 */
...
/**
 * Region map (poke target → chips):
 * 頭 · face / eyes / mouth / jaw / head / throat
 * 心 · chest / heart / breath / heat / shoulders
 * 肚 · belly / appetite / toilet
 * 手 · fists / sweat / shake / soft hands
 * 腳 · jump / tense / curl / float
 */
export const BODY_CHIPS: BodyChipDef[] = [
  ...
  { key: 'smile_wide', emoji: '😊', label: '嘴角上揚', animation: 'smile_pull', region: 'head', decorSpot: 'face' },
  ...
  { key: 'throat_tight', emoji: '🪨', label: '喉嚨哽哽', animation: 'throat_catch', region: 'head', decorSpot: 'face' },
  // ── 心（胸口／膊）──
  ...
  { key: 'shoulders_heavy', emoji: '🎒', label: '膊頭好重', animation: 'shoulders_drop', region: 'chest', decorSpot: 'auraL' },
  // ── 肚──
