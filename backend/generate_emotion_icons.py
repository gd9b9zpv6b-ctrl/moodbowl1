...
EMOTIONS = [
    ...
    ("foggy",        "soft pale dove grey-blue",        RICE_TINY,
     ...
     "pale misty grey"),
    # questioning — 唔知乜感覺, bowl filled with QUESTION MARKS instead of rice
    ("questioning",  "soft warm cream beige",           RICE_TINY,
     "the INSIDE of the bowl contains NO RICE OR ALMOST NO RICE — instead the bowl is FILLED and OVERFLOWING with a big pile of BOLD BLACK CARTOON QUESTION MARKS '?' of various sizes stuffed inside like rice grains (about 8-12 question marks piled up), with several of them sticking UP above the rim of the bowl and one or two POKING OUT AT ANGLES like they're spilling over the sides; the biggest question mark in the middle towers above the pile; the whole bowl clearly TILTED to one side (about 20 degrees) in a cute curious head-tilt pose; the mascot's own face on the front of the bowl shows a genuinely curious puzzled look — two wide round black dot eyes looking upward at the pile of question marks, a small o-shaped open mouth as if going 'huh?', pink blush cheeks, one tiny stubby hand raised palm-up in a shrug gesture; overall clear vibe of 'my head is full of question marks, I don't know what I feel'",
     "warm buttercream"),
    # blank — 一片空白, RICE COOKER with lid open, empty inside, DEAD-INSIDE vacant face
    ("blank",        "white and cream electric RICE COOKER appliance (NOT a ceramic bowl this time — a chubby rounded rice cooker with a small square digital control panel with two tiny buttons on the front, a short black electric cord trailing off to one side, and a metal handle on top)",
     ...
     "warm ivory white"),
    # indescribable — 一言難盡, NO EYES, face is a big six-dot Chinese ellipsis
    ("indescribable","soft dusty periwinkle blue",      RICE_HALF,
     "the mascot has ABSOLUTELY NO EYES on its face (do not draw any eyes at all — leave that area completely blank). Instead the ENTIRE FACE / expression is made up of a big CHINESE-STYLE SIX-DOT ELLIPSIS '……' — SIX bold black dots arranged in one long horizontal row (or two neat rows of three) across the center of the bowl's front where the eyes and mouth would normally be; each dot is bold, evenly sized and evenly spaced, clearly the ONLY facial feature; small pink blush cheeks on either side of the ellipsis; ADDITIONALLY beside its head floats a small round white cartoon speech bubble ALSO containing a matching six-dot ellipsis '……' inside (same style as the face); one tiny stubby hand raised halfway toward its mouth area as if trying to speak but stopping mid-word; overall poetic 欲言又止 vibe of 'so much I want to say, but I trail off into silence'",
     "soft powder blue"),
]
